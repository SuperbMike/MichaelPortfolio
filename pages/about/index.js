...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'Data Analyst - Bruxelles Formation',
        stage: '2012 - 2023',
      },
      {
        title: 'Operations Analyst - Andy Drinks',
        stage: '2022 - 2023',
      },
      {
        title: 'Operations Supervisor - Gorillas',
        stage: '2021-2023',
      },
    ],
  },
  {
    ...
    info: [
      ...
      {
        title: 'Microsoft Azure Data Essentials DP-900',
        stage: '2023',
      },
      {
      ...
      {
        title: 'Accounting and Business Economics Bachelor, London, UK',
        stage: '2017',
      },
    ],
  },
...
const About = () => {
  ...
  return (
    <div className='h-full bg-primary/30 py-16 text-center xl:text-left'>
      ...
      >
        {/* Assuming Avatar component is imported */}
        <Avatar />
      </motion.div>

      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 mt-16'>
        {/* text */}
